        ...
        <div className="rb-12 mb-12 w-full max-w-lg md:mb-18 lg:mb-20">
          <div className="w-full max-w-lg">
            ...
            <p className="md:text-md">
              Understanding visitation, family dynamics, and the work of
              building trust across difficult terrain.
            </p>
          </div>
        </div>
        <div className="flex flex-col justify-start">
          ...
          <div className="rb-12 mb-12 grid grid-cols-1 items-start gap-x-8 sm:gap-y-14 md:mb-16 lg:mb-20 lg:grid-cols-2">
            <div>
              <div className="flex h-full flex-col items-start justify-center">
                ...
                <p>
                  How structured visitation can heal fractured relationships and
            ...
            <div className="grid grid-cols-1 gap-y-8 md:gap-y-12 lg:gap-y-8">
                ...
                <div className="flex h-full flex-col items-start justify-center">
                  ...
                  <a className="mb-2" href="#">
                    <h3 className="text-xl font-bold md:text-2xl">
                      When visitation becomes a bridge
                    </h3>
                  </a>
                  <Button
                    title="Read more"
              ...
              <div className="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-[0.5fr_1fr] md:gap-y-4">
                ...
                <div className="flex h-full flex-col items-start justify-center">
                  ...
                  <a className="mb-2" href="#">
                    <h3 className="text-xl font-bold md:text-2xl">
                      The role of neutrality in difficult conversations
                    </h3>
                  </a>
                  <Button
                    title="Read more"
          ...
          <div className="grid grid-cols-1 gap-x-12 gap-y-12 md:grid-cols-2 md:gap-y-16">
            <div className="flex size-full flex-col items-start justify-start text-start">
              ...
              <a className="mb-2 flex justify-start text-start" href="#">
                <h2 className="text-xl font-bold md:text-2xl">
                  Coaching families through transition
                </h2>
              </a>
              <p>
                Why impartial presence matters when families are in conflict and
                seeking resolution.
              </p>
              <Button
                title="Read more"
            ...
            <div className="flex size-full flex-col items-start justify-start text-start">
              ...
              <a className="mb-2 flex justify-start text-start" href="#">
                <h2 className="text-xl font-bold md:text-2xl">
                  Building safety into every visit
                </h2>
              </a>
              <p>
                Clear records of visitation and interactions provide clarity and
            ...
            <div className="flex size-full flex-col items-start justify-start text-start">
              ...
              <p>
                Supporting parents and children as they navigate new
                relationship structures with dignity.
              </p>
              <Button
                title="Read more"
                variant="link"
            ...
            <div className="flex size-full flex-col items-start justify-start text-start">
              ...
              <a className="mb-2 flex justify-start text-start" href="#">
                <h2 className="text-xl font-bold md:text-2xl">
                  The weight of the first meeting
                </h2>
              </a>
              <p>
                Practical steps for creating an environment where all family
                members feel secure and respected.
              </p>
              <Button
                title="Read more"
                variant="link"
